...
@Component({
  ...
  template: `
    ...
    @if (isDemo) {
      <div class="demo">
        <p>
          This demo showcases the features of <strong>Tapiz</strong> directly in
          your browser. For the full experience with real-time collaboration,
        ...
        <p>Thank you for trying <strong>Tapiz</strong>!</p>
      </div>
    } @else {
      <div class="copy-url">
        <mat-form-field>
